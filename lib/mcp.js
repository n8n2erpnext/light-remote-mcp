const MCP_URL = process.env.VPS_MCP_URL || 'https://mcp.example.invalid/mcp';
const MCP_AUDIENCE = process.env.VPS_MCP_AUDIENCE || 'https://mcp.example.invalid';
...
async function callMcpTool(name, args = {}, { bridgeSession = '' } = {}) {
