...
const bridgeSource=fs.readFileSync(new URL('../../lib/operator.js',import.meta.url),'utf8');
// bridge_dual_transport
assert.match(bridgeSource,/headers\['x-light-client'\]\s*=\s*plusClient/);
assert.match(bridgeSource,/headers\.cookie\s*=\s*'light_remote_client='/);
console.log('v09-client-registry-reload=PASS');
console.log('v09-client-bridge-dual-transport=PASS');
