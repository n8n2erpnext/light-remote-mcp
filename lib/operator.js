...
async function callOperator(path, { method = 'GET', body = null, timeoutMs = 9000 } = {}) {
...
async function execOperator(payload) { return callOperator('/operator', { method: 'POST', body: sealOperatorPayload(payload), timeoutMs: 9500 }); }
