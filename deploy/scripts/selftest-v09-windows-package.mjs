...
const mainForm=read('client/windows-native/GptOperator.Client/MainForm.cs');
const settingsDialog=read('client/windows-native/GptOperator.Client/ConnectionSettingsDialog.cs');
...
expect(installer.includes("'Light Remote MCP'")&&installer.includes("'GPT Operator'"),'windows_installer_legacy_autostart_cleanup_missing');
