...
need(src.includes('OPERATOR_RING_AGE_MS || 60 * 60 * 1000'),'ring_age_60m_missing');
need(src.includes('restoreActivityRing({files:logFilesOldestFirst()'),'ring_disk_restore_wiring_missing');
