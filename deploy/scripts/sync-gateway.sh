...
mkdir -p "$BACKUP"
for f in server.mjs activity.mjs security.mjs workspace.mjs dashboard.mjs operator-proxy.mjs wall-auth.mjs enrollment-page.mjs device-policy-page.mjs Dockerfile package.json package-lock.json; do
