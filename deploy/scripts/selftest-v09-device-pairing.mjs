...
const a1=registry.currentOrRotate(args);assert.match(a1.code,/^[A-Z2-9]{4}-[A-Z2-9]{4}$/);assert.equal(a1.ttlMs,180000);const a1Reload=registry.currentOrRotate(args);assert.equal(a1Reload.code,a1.code);assert.equal(a1Reload.pairingId,a1.pairingId);
...
console.log('v09-device-pairing-a-reload-reuse=PASS');
