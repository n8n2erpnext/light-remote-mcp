...
need(usage.includes('/api/auth?action=usage')&&settings.includes('/api/auth?action=me')&&!usage.includes('/api/account-me')&&!settings.includes('/api/account-me'),'account-portal-subpage-auth-router');
