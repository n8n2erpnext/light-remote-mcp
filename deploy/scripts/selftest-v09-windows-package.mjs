...
expect(supervisor.includes('EnsureServiceAsync')&&supervisor.includes('StopServiceAsync'),'always_alive_service_supervision_missing');
expect(supervisor.includes('RunAgentAsync("connect"')&&supervisor.includes('RunAgentAsync("disconnect"'),'finite_cloud_connect_controls_missing');
expect(supervisor.includes('_serviceDesired'),'service_cloud_lifecycle_not_separated');
expect(form.includes('Dormant')&&form.includes('Background service is alive locally'),'windows_dormant_ui_missing');
