...
- Full static regression after this work is 39/39 PASS; root and gateway audits remain zero known vulnerabilities. Native OAuth dogfood now covers ARM, AMD and Windows plus typed file/list/search/process convenience tools, including a harmless spawn/terminate proof. Production/public OAuth deployment proof is the next gate before beta promotion.
