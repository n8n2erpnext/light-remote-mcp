...
function auth(){const s=env('NETLIFY_BRIDGE_SECRET')||env('LIGHT_REMOTE_N_BRIDGE_SECRET');if(!s)throw new Error('netlify_bridge_secret_unavailable');return {'x-light-netlify-bridge':s}}
