...
export function deviceHeartbeatMessage({ deviceId, timestamp, nonce, capabilities = [], supportedCapabilities = null }) {
  const message={
    version: 1,
  ...
  if(Array.isArray(supportedCapabilities))message.supportedCapabilities=normalizeDeviceCapabilities(supportedCapabilities);
