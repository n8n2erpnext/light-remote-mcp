...
function toolHelperView(contextEnvelope={}){
  ...
  return {
    ...
    chooseTool:[
      ...
      'Use process-* for long-running or stdin/stdout-driven processes; select only a shell mode advertised in target.shellModes.',
    ...
    policy:{profiles:['safe','developer','infra','full','custom'],rule:'Profiles are ceilings over device-grantable capabilities. Infra does not automatically imply sudo/UAC; privilege elevation remains separately governed.'},
