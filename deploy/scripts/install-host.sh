...
for lib in device-proof.mjs native-fs.mjs native-process.mjs native-terminal.mjs native-search.mjs light-scp-file.mjs light-scp-registry.mjs update-contract.mjs runtime-version.mjs version-compat.mjs update-helper-reconcile.mjs brand.mjs; do
