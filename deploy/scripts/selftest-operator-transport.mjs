...
const opened=normalizeSessionOpenPayload({...sample,leaseMs:600000});
if(opened.leaseMs!==600000||opened.agentId!==sample.agentId) throw new Error('session_open_normalization_failed');
